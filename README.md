...
This repository contains my hands-on exercises, assignments, solutions, and practice programs completed as part of the Cognizant Digital Nurture - Java Full Stack Engineer (Java FSE) training program.
...
* Assertions in JUnit
* AAA Pattern, Test Fixtures, Setup and Teardown
...
* Git-HOL 1 - Git Basics and Configuration
* Git-HOL 2 - Using `.gitignore`
* Git-HOL 3 - Git Branching and Merging
* Git-HOL 4 - Merge Conflict Resolution
* Git-HOL 5 - Clean Up and Push Changes to Remote Git
...
* Clean Up and Remote Push

## About This Repository

This repository contains my learning journey for the Cognizant Digital Nurture - Java Full Stack Engineer program.
...
The repository is organized module-wise to make navigation easier and track my learning progress throughout the Digital Nurture program.
